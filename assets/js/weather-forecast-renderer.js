    ...
    for (let i = 0; i < 5 ; i++) {
      html += `
        <div type="button" id="day-${i + 1}-btn" class="btn me-sm-1 me-lg-0 me-xl-1 mb-1 mb-sm-0 mb-lg-1 mb-xl-0 p-0">
          <div id="weather-forecast-inner">
            <h4 class="mb-0 mb-sm-3 mb-md-0 mb-xl-3 ms-1 ms-sm-0 ms-md-2 ms-xl-0 text-start text-sm-center text-md-start text-xl-center">${model.forecast[i].dayShort}</h4>
            ...
            <h5 class="mb-0 mb-sm-1 mb-lg-0 mb-xl-1">${model.forecast[i].temp}°C</h5>
